...
import type { PayablesData, PayableSupplier } from "@/lib/recon-data";
import { payToSupplier, removePurchasePayment } from "@/lib/purchase-pay";
...
export function PayablesUi({ data }: { data: PayablesData }) {
