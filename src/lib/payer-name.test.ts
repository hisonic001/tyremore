...
describe("readPayer — 표 (이름 · via · 지역 · hint)", () => {
  ...
  const rows: Row[] = [
    ...
    /**
     * 🔴 결제대행 뒤 음식점 (2026-09-14 고침): 전엔 결제대행 사전(네이버페이)이 먼저 known 에 잡혀
     *    「음식점으로 보입니다」 제안이 안 나왔다 — 네이버페이·카카오페이로 낸 밥값 전부.
     *    이제 실제 상대 이름의 음식점 판정이 결제대행 설명보다 먼저다.
     */
    { source: "법인카드", desc: "네이버페이 갈비시대", name: "갈비시대", via: "네이버페이", hint: "식대·접대", what: "음식점으로 보입니다", why: "결제대행 뒤 음식점은 음식점이 이긴다" },
    { source: "법인카드", desc: "카카오페이-송도물회", name: "송도물회", via: "카카오페이", hint: "식대·접대", what: "음식점으로 보입니다", why: "카카오페이도 같다" },
