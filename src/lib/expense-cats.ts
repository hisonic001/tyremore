...
export const CARD_SETTLE_PATTERN_SQL =
   ...
   */
  /**
   * ⭐ 토스 간편결제 정산 (사장님 확인 2026-09-04): 「[타행FB] 토스_2026090…」 —
   *    토스페이로 결제한 판매의 정산 입금이다. 판매는 앱에 이미 세어져 있으므로
   *    카드사 정산과 같은 묶음. 손님이 토스로 직접 이체한 돈은 보낸 사람 이름으로
   *    찍히지 「토스_숫자」 꼴이 아니다 — 날짜 숫자가 붙은 것만 잡는다.
   */
